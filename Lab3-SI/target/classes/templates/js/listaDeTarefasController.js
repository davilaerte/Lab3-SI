...
app.controller("listaDeTarefasController", function($scope, $http, $location, $routeParams, $filter) {
	...
	(function () {
		$http.get("http://" + location.host + "/ListaDeTarefa/"+ $routeParams.idLista).success(function (data, status){
	...
	$scope.editarTarefaAtual = function() {
		...
		$http.put("http://" + location.host + "/ListaDeTarefa/"+ $routeParams.idLista + "/tarefa/"+ $scope.updateTarefa.id, $scope.updateTarefa).success(function (data, status) {
	...
	$scope.addTarefa = function() {
		...
		$http.put("http://" + location.host + "/ListaDeTarefa/"+ $routeParams.idLista + "/tarefa", novaTarefa).success(function (data, status) {
	...
	$scope.tarefaEstaConcluida = function(tarefa) {
		...
		$http.put("http://" + location.host + "/ListaDeTarefa/"+ $routeParams.idLista + "/tarefa/"+ tarefa.id, tarefa).success(function (data, status) {
	...
	$scope.addSubtarefaEmTarefa = function() {
		...
		$http.put("http://" + location.host + "/ListaDeTarefa/"+ $routeParams.idLista + "/tarefa/"+ $scope.TarefaParaAddSubTarefa.id + "/subtarefa"
	...
	$scope.subtarefaEstaConcluida = function(tarefa, subtarefa) {
		...
		$http.put("http://" + location.host + "/ListaDeTarefa/"+ $routeParams.idLista + "/tarefa/"+ tarefa.id + "/subtarefa/" + subtarefa.id
				, subtarefa).success(function (data, status) {
	...
	$scope.removerTarefaDaLista = function(tarefa) {
		...
		$http.delete("http://" + location.host + "/ListaDeTarefa/" + $routeParams.idLista + "/tarefa/" + tarefa.id 
	...
	$scope.removerTodasAsTarefas = function() {
		...
		$http.delete("http://" + location.host + "/ListaDeTarefa/" + $routeParams.idLista + "/tarefa/all" 
		).success(function (data, status){
